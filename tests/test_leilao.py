...
class TestLeilao(TestCase):
    ...
    def test_deve_permitir_propor_um_lance_caso_o_ultimo_lance_seja_de_outro_usuario(self):
        yuri = Usuario('Yuri', 500.0)
    ...
    def test_nao_deve_permitir_propor_lance_caso_o_ultimo_lance_seja_do_mesmo_usuario(self):
